    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $empleado->edad }}</td>
                <td>{{ $empleado->sexo }}</td>
                <td>{{ $empleado->cve_tipo_contrato }}</td>
                <td>{{ $empleado->cve_periodo }}</td>
                <td>{{ $empleado->tipo_de_empleado }}</td>
                <td>{{ $empleado->centro_proceso_nomina }}</td>
                <td>{{ $empleado->area_de_adscripcion }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
